const NetLicensingDemo = function () {
  ...
  var licensee = new NetLicensing.Licensee().setNumber(licenseeNumber).setName(licenseeNumber + 'na');
  ...
  var license = new NetLicensing.License().setNumber(licenseNumber);
  ...
  var PaymentMethodsServicePromise = LicenseServicePromise.then(function () {
    ...
    return NetLicensing.PaymentMethodService.list(context).then(function (paymentMethods) {
  ...
  // region ********* Token
  var token = new NetLicensing.Token().setTokenType('APIKEY');
  ...
  var TransferPromise = ValidationPromise.then(function () {
    ...
    var transferLicensee = new NetLicensing.Licensee().setNumber('TR' + licenseeNumber).setMarkedForTransfer(true);
    ...
    return NetLicensing.LicenseeService.create(context, productNumber, transferLicensee)
      .then(function (transferLicensee) {
        ...
        var transferLicense = new NetLicensing.License().setNumber('TR' + licenseNumber);

        return NetLicensing.LicenseService.create(
          context,
  ...
  var TransferWithApiKeyPromise = TransferPromise.then(function () {
    ...
    return NetLicensing.LicenseeService.create(context, productNumber, transferLicenseeWithApiKey)
      .then(function (transferLicenseeWithApiKey) {
        ...
        var transferLicenseWithApiKey = new NetLicensing.License().setNumber('AP' + licenseNumber);
      ...
      .then(function (newTransferLicense) {
        console.log('LicenseeService.create(transfer-to) :', newTransferLicense);
        context.setSecurityMode(NetLicensing.Constants.APIKEY_IDENTIFICATION);
        return NetLicensing.LicenseeService.transfer(
          context,
          licensee.getNumber(),
          transferLicenseeWithApiKey.getNumber(),
        );
